...
async function handleRecaptchaFlow(authInstance, request, actionName, actionMethod, recaptchaAuthProvider) {
	if (recaptchaAuthProvider === "EMAIL_PASSWORD_PROVIDER") if (authInstance._getRecaptchaConfig()?.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")) {
	...
	else if (recaptchaAuthProvider === "PHONE_PROVIDER") if (authInstance._getRecaptchaConfig()?.isProviderEnabled("PHONE_PROVIDER")) {
...
async function signInWithPopup(auth, provider, resolver) {
	...
	return new PopupOperation(authInternal, "signInViaPopup", provider, resolverInternal).executeNotNull();
}
/**
...
async function _getRedirectResult(auth, resolverExtern, bypassAuthState = false) {
	...
	const result = await new RedirectAction(authInternal, resolver, bypassAuthState).execute();
